...
grayscale_spec_dataset_path = dataset_path + "/spec/9grayscale"
...
sampling = 22050
window_values = [2040, 2042, 2044, 2046, 2048, 2050, 2052, 2054, 2056]
overlap_rate = 0.5
    ...
    for file in filelist:
        ...
        for window_value in window_values:
            ...
            if not os.path.exists(save_name):
                ...
                print(f"[LOG] {filename} -> /spec/9grayscale/{q}/2048s/{filename_no_extension}{param_data}.png")
    print("--------------------")
...
for q in ['Q1', 'Q2', 'Q3', 'Q4']:
    ...
    print(f"[INFO] Datas in spec/9grayscale/{q}/2048s: {count}")
