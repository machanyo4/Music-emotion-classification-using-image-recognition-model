...
grayscale_spec_dataset_path = dataset_path + "/spec/1grayscale"
    ...
    for file in filelist:
        ...
        for window_value in window_values:
            ...
            if not os.path.exists(save_name):
                ...
                print(f"[LOG] {filename} -> /spec/1grayscale/{q}/2048s/{filename_no_extension}{param_data}.png")
    print("--------------------")
...
for q in ['Q1', 'Q2', 'Q3', 'Q4']:
    ...
    print(f"[INFO] Datas in spec/1grayscale/{q}/2048s: {count}")
